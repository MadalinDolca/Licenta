...
public class BannerMelodieProfilAdapter extends RecyclerView.Adapter<BannerMelodieProfilAdapter.BannerMelodieProfilViewHolder> {
    private Context context;
    private List<Melodie> listaMelodii;

    public BannerMelodieProfilAdapter(Context context, List<Melodie> listaMelodii) {
    ...
    @NonNull
    @Override
    public BannerMelodieProfilViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View viewBannerMelodie = LayoutInflater.from(context).inflate(R.layout.layout_banner_melodie, parent, false);

        return new BannerMelodieProfilViewHolder(viewBannerMelodie);
    }

    @Override
    public void onBindViewHolder(@NonNull BannerMelodieProfilViewHolder holder, int position) {
        ...
        // editare melodie la apasarea butonului de edit
        holder.imageViewButonEdit.setOnClickListener(v -> {
            Intent intent = new Intent(context, EditareMelodieActivity.class);
            intent.putExtra(NumeExtra.EDITARE_MELODIE, listaMelodii.get(position)); // extra cu melodia selectata
    ...
    public static class BannerMelodieProfilViewHolder extends RecyclerView.ViewHolder {
        ...
        public BannerMelodieProfilViewHolder(@NonNull View itemView) {
            super(itemView);
